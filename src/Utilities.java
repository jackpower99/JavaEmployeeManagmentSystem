...
public class Utilities {
    ...
    static boolean isLetters(String string){
        return string.matches("[a-zA-Z]+");
    }

//    public static Genre validGenre(String lookingFor, GenreList allGenres){
//        ArrayList<Genre> allGenreslist = allGenres.getGenreList();
//        // lookingFor = lookingFor.toUpperCase();
//        for (Genre tempGenre:allGenreslist) {
//
//            if (tempGenre.getGenreName().equals(lookingFor))
//                return tempGenre;
//        }
